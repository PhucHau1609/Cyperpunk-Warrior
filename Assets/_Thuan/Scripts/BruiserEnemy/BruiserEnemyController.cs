...
public class BruiserEnemyController : MonoBehaviour, IDamageResponder
{
    ...
    private BruiserEnemyDamageReceiver damageReceiver;
    ...
    void Awake()
    {
        ...
        damageReceiver = GetComponent<BruiserEnemyDamageReceiver>();
    ...
    public void OnDamageReceived()
    {
        ...
        if (healthBarEnemy != null)
        {
            healthBarEnemy.ShowHealthBar(damageReceiver.CurrentHP);
        }
