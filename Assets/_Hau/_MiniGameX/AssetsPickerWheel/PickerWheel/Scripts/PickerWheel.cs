...
namespace EasyUI.PickerWheelUI
{
    public class PickerWheel : MonoBehaviour
    {
      ...
      /*  [Space]
        ...
        [SerializeField] private RewardDisplay rewardDisplay; // Thêm reference tới RewardDisplay*/
        ...
        public virtual void Spin()
        {
            if (!_isSpinning)
            {
                ...
                .OnComplete(() => {
                    ...
                    // Hiển thị reward display khi quay xong
                   /* if (rewardDisplay != null)
                    {
                        rewardDisplay.ShowReward(piece);
                    }*/
